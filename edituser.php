...
<title>Edit User - Toko Sport</title>
...
<div class="main-container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Formulir Perubahan Data Pengguna Sistem</p>
        </div>
    ...
    <div class="card">
        <div class="card-body p-4">
            <h4 class="card-title mb-4 fw-bold text-dark">
                <i class="bi bi-pencil-square text-warning me-2"></i>Edit Data User
            </h4>
            ...
            <form method="POST">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Password <span class="text-muted fw-normal fs-7">(Kosongkan jika tak diubah)</span></label>
                            <div class="input-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <select name="role" class="form-select" required>
                                    <option value="user" <?= $data['role']=='user'?'selected':'' ?>>User / Pelanggan</option>
                                    <option value="admin" <?= $data['role']=='admin'?'selected':'' ?>>Admin / Administrator</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <select name="status" class="form-select" required>
                                    <option value="aktif" <?= $data['status']=='aktif' || $data['status']=='active'?'selected':'' ?>>Aktif (Dapat Login)</option>
                                    <option value="nonaktif" <?= $data['status']=='nonaktif' || $data['status']=='inactive'?'selected':'' ?>>Nonaktif (Ditangguhkan)</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="alamat" class="form-control" rows="1" required><?= htmlspecialchars($data['alamat']) ?></textarea>
                        </div>
                    </div>
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" name="update" class="btn btn-warning text-white px-4">
                        <i class="bi bi-save me-1"></i> Update Data User
                    </button>
                </div>
