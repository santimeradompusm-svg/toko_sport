    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            ...
            <div class="d-flex align-items-center">
                <span class="me-3 text-muted"><i class="bi bi-bell"></i></span>
        ...
        <div class="cart-container">
            <table class="table align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-group input-group-sm" style="width: 110px;">
                                ...
                                <input type="text" class="form-control text-center" value="<?= $row['jumlah']; ?>">
                                <button class="btn btn-outline-secondary">+</button>
                            </div>
                        </td>
                    ...
                    <?php endwhile; ?>
                    <?php else: ?>
                    <tr><td colspan="6" class="text-center py-5 text-muted">Keranjang Anda masih kosong.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
            ...
            <div class="d-flex justify-content-end align-items-center mt-4 border-top pt-3">
                <span class="me-4 fs-6">Total Harga: <strong class="text-theme fs-4">Rp <?= number_format($total_semua, 0, ',', '.'); ?></strong></span>
                <a href="checkout.php" class="btn btn-theme">Checkout Sekarang</a>
            </div>
            <?php endif; ?>
        </div>
    </div>
